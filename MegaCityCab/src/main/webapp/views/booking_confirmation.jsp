...
<html>
<head>
<body style="background: url('..image/Assets/bg4.jpg') no-repeat center center; background-size: cover;">
...
body {
    ...
    background-color: #f2bdbd; /* Dark background */
    color: #1c1b1b; /* White text */
    margin: 0;
    padding: 0;
    text-align: center;
}
